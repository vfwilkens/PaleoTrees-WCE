...
output_path <- here("./data/data_3/occurrence_data_filtered/")
...
# write.csv(all_occurrences, here("./data/data_3/occurrences.csv"))
```
...
```{r, eval = FALSE}
# all_occurrences <- read.csv(here("./data/data_3/occurrences.csv"))
...
# writeRaster(proj, here("./data/data_3/sampbias_0_25deg.tif"))
...
# writeRaster(weights, here("./data/data_3/weights_0_25deg.tif"))
```
...
megatree <- read.tree(here("./data/data_3/GBOTB.extended.WCVP.tre"))
plant_genus_list <- read.csv(here("./data/data_3/plant_genus_list.csv"))

# Specify output path where to save the phylogenies as .nex files.
tree_output_path <- here("./data/data_3/trees/")
