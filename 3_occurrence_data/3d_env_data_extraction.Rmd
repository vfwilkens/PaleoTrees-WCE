...
```{r, eval = FALSE}
all_occurrences <- read.csv(here("./data/data_3/occurrences.csv"))[, -1]

bioclim_current_global <- rast(here("./data/data_2/bioclim_current_global_0_25deg.tif"))
weights <- rast(here("./data/data_3/weights_0_25deg.tif"))
...
all_occurrences_extracted <- na.omit(all_occurrences_extracted)
```
...
all_occurrences_extracted$status <- ifelse(all_occurrences_extracted$species %in% native_species, "native_species", "non-native_species")

all_occurrences_extracted$genus2 <- ifelse(all_occurrences_extracted$status == "native_species",
