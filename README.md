...
* "2_climate_data" - Prepare current and future climate data, then extract for all occurrences
* "3_occurrence_data" - Download and filter species occurrence data from GBIF.
...
* "dashboard" - Contains the interactive dashboard for exploring the data.
