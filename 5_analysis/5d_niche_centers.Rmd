...
p1 <- ggplot() +
  # geom_point(data = combined_data, aes(x = bio1, y = bio12, color = group, fill = group), alpha = 0.02, size = 2, shape = 15) +
  stat_density_2d(
    data = combined_data,
  ...
  geom_point(
    data = all_data_centers[all_data_centers$plot_Rhat == 1 & all_data_centers$plot_divtrans == 1, ],
  ...
  xlim(3, 28) +
  ylim(400, 3200) +
  geom_text(data = all_data_centers[all_data_centers$plot_label == 1, ], aes(x = bio1, y = bio12, label = label), parse = TRUE, size = 6 / .pt) +
  stat_ellipse(data = all_data_centers[all_data_centers$category == "HRTF", ], aes(x = bio1, y = bio12), color = "black", linetype = "longdash", linewidth = mm(0.15)) +
  ...
  scale_size_continuous(range = c(1, 10), limits = c(1, 850), breaks = c(1, 5, 10, 50, 100)) +
...
p2 <- ggplot() +
  ...
  scale_size_continuous(range = c(1, 5), limits = c(1, 850), breaks = c(1, 5, 10, 50, 100)) +
  stat_ellipse(data = all_data_centers[all_data_centers$category == "HRTF", ], aes(x = bio1, y = bio12), color = "black", linetype = "longdash", linewidth = mm(0.15)) +
  scale_shape_manual(values = c(
    "EG" = 21, "HRTF" = 24,
    "REG" = 21
...
ggsave(plot = p2, filename = "Fig4b_last_occurrences.pdf", path = here("figures"), width = 80, height = 60, device = "pdf", units = "mm", bg = "white")
```