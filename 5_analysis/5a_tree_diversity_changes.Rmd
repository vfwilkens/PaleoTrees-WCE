...
plot1 <- ggplot(data = paleotrees_summary) +
  ...
  theme_minimal() +
  scale_y_continuous(limits = c(0, 180), breaks = seq(0, 180, by = 25), minor_breaks = setdiff(seq(0, 180, by = 5),seq(0, 180, by = 25)),guide = guide_axis(minor.ticks = TRUE)) +
  theme(
...
plot2 <- ggplot(paleotrees_summary, aes(y = value, x = min_ma, xend = max_ma, yend = value, color = higher)) +
  ...
  scale_x_reverse(limits = c(0, 66), breaks = seq(0, 66, by = 20), minor_breaks = setdiff(seq(0, 66, by = 5),seq(0, 66, by = 20)),guide = guide_axis(minor.ticks = TRUE)) +
  theme_minimal() +
  scale_y_continuous(limits = c(0, 180), breaks = seq(0, 180, by = 25), minor_breaks = setdiff(seq(0, 180, by = 5),seq(0, 180, by = 25)),guide = guide_axis(minor.ticks = TRUE)) +
  theme(
    legend.position = "none",
